...
function Regulation() {
  return (
    <Container className='regulation_content'>
        <h1 className='text-center mb-5' style={{
            color: '#34A853'
        }}>Điều khoản và Quy định</h1>
        <h2>1. Giới thiệu</h2>
        ...
        <h2>3. Quyền và Trách Nhiệm của TravelMate</h2>
        <ul>
