...
function Destination() {
    ...
    const tours = [
        {
            id: 1,
            name: 'Tour Hà Giang 3 ngày 2 đêm',
            price: formatPrice(2500000),
            image: 'https://images.unsplash.com/photo-1670993077545-bfeeea1e0b5f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8dG91ciUyMGR1JTIwbCVFMSVCQiU4QmNoJTIwZGElMjBuYW5nfGVufDB8fDB8fHww',
            localName: 'Nguyễn Minh Trí',
            localAvatar: 'https://images2.thanhnien.vn/528068263637045248/2023/7/11/my-tam-121-16890426245471165837760.jpeg',
            rating: 4.7,
            trip: 20,
            timeParticipate: '2023-05-15',
            localLocation: 'Đà Nẵng',
        },
        {
            id: 3,
