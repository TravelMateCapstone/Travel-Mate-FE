...
function LocalTripHistory() {
  ...
  return (
    <Container fluid className="w-100 px-0 border-0 rounded-5">
                ...
                <>
                  <Row key={index} className="border-bottom rounded p-3 mb-3 bg-white">
                    ...
                    <Col md={3} className="d-flex align-items-center">
                      <img src={favorite.tourImage} alt={favorite.tourName} style={{ width: "100%", height: "150px", objectFit: "cover", borderRadius: "8px" }} />
                    </Col>
                    {/* Phần thông tin */}
                    <Col md={3}>
