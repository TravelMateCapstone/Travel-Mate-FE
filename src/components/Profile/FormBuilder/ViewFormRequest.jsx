...
function ViewFormRequest() {
  ...
  return (
    <div className='w-25 p-4 rounded-4' style={{
      background: '#d9d9d9'
    }}>
      <h5 className='text-center'>Yêu cầu kết nối</h5>
      <h6 className='my-3'>Thời gian</h6>
      <Row className='mb-3'>
        <Col><DateTimeInput placeholder='Nhập ngày bắt đầu' value={formatDateTime(formData.startDate)} /></Col>
        <Col><DateTimeInput placeholder='Nhập ngày kết thúc' value={formatDateTime(formData.endDate)} /></Col>
      </Row>
      <h6>Dịch vụ</h6>
