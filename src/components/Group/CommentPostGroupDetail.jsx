  ...
  return (
    <div className="d-flex ">
      <div className='d-flex gap-3 w-100 comment-container'>
        <img src={comment.commentorAvatar || 'https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg'} alt="avatar comment" width={40} height={40} className='rounded-circle object-fit-cover' />
        <div className='comment-text-info w-100'>
          <div className='d-flex justify-content-between align-items-center'>
            <div className=''>
              ...
              <p className='comment_time fw-medium' style={{ fontSize: '12px' }}>{new Date(comment.commentTime).toLocaleString()}</p>
            </div>
          </div>
          <div className="comment_content_wrapper" style={{ marginBottom: '25px' }}>
            {isEditing ? (
              <>
                <TextareaAutosize
                  value={editedComment}
